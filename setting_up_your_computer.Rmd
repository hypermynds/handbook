...
GitHub no longer accept the password authentication since August 2021, now is
necessary a SSH key to access to your repositories.
...
* Copy your public key with the command `pbcopy < ~/.ssh/github.pub` and paste
  the key in the section *SSH and GPG keys* of your GitHub settings.
